...
Food
	- Semmel sponsoring
	  Y: find (KHG Mensa?) topings
	  N: alternative like Samosas 
	  Hurry for Curry quote: 4€/Samosa with dips
Drinks
	- Commission-based approach
	  Y: find a good deal
	  N: start to stockpile and get direct drinks sponsors as part of this
	  Red Bull: flat rate package sponsorship an option?
```